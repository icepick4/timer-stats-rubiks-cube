...
class Button:
    def __init__(self, screen, text, font, bgColor, color, pos):
        ...
        self.buttonRect = self.buttonSurface.get_rect(topleft = (self.fontRect.left - self.fontRect.w * 0.1, self.fontRect.top - self.fontRect.h * 0.15))
    ...
    def display(self):             
        pygame.draw.rect(self.screen, self.bgColor, self.buttonRect, 3, border_radius = 20)
